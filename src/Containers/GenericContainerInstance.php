...
class GenericContainerInstance implements ContainerInstance
{
    ...
    public function getExposedPorts()
    {
        ...
        if (!is_array($this->containerDef['mappingPort'])) {
            return [];
        }
        return array_keys($this->containerDef['mappingPort']);
    }
    ...
    public function getMappedPort($exposedPort)
    {
        ...
        return $this->containerDef['mappingPort'][$exposedPort];
    }
